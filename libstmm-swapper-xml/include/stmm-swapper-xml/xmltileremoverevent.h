 ...
 */
/*
 * File:   xmltileremoverevent.h
 */

#ifndef STMG_XML_TILE_REMOVER_EVENT_H
#define STMG_XML_TILE_REMOVER_EVENT_H
...
public:
	...
	TileRemoverEvent::Init parseTileRemoverEvent(GameCtx& oCtx, const xmlpp::Element* p0Element);
...
private:
	XmlTileRemoverEventParser(const XmlTileRemoverEventParser& oSource) = delete;
	XmlTileRemoverEventParser& operator=(const XmlTileRemoverEventParser& oSource) = delete;
};

} // namespace stmg

#endif	/* STMG_XML_TILE_REMOVER_EVENT_H */
