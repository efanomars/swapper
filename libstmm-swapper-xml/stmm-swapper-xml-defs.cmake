# File: libstmm-swapper-xml/stmm-swapper-xml-defs.cmake
...
set(STMM_SWAPPER_XML_MINOR_VERSION 23) # !-U-!
...
set(STMM_SWAPPER_XML_REQ_STMM_SWAPPER_MINOR_VERSION 23) # !-U-!
...
set(STMM_SWAPPER_XML_REQ_STMM_GAMES_XML_GAME_MINOR_VERSION 23) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-swapper-xml)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-swapper-xml SHARED IMPORTED)
#     else()
#         add_library(stmm-swapper-xml STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-swapper-xml PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-swapper-xml PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMSWAPPERXML_INCLUDE_DIRS}")
#     set(STMMI_TEMP_PROPS "")
#     get_target_property(STMMI_TEMP_STMMSWAPPER_PROP stmm-swapper INTERFACE_LINK_LIBRARIES)
#     list(APPEND STMMI_TEMP_PROPS "${STMMI_TEMP_STMMSWAPPER_PROP}")
#     list(APPEND STMMI_TEMP_PROPS "stmm-swapper")
#     list(APPEND STMMI_TEMP_PROPS "${STMMGAMESXMLGAME_LIBRARIES}")
#     set_target_properties(stmm-swapper-xml PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMI_TEMP_PROPS}")
# endif()
