# File: libstmm-swapper/stmm-swapper-defs.cmake
...
set(STMM_SWAPPER_MINOR_VERSION 24) # !-U-!
...
set(STMM_SWAPPER_REQ_STMM_GAMES_MINOR_VERSION 24) # !-U-!
...
# if (("${CMAKE_SCRIPT_MODE_FILE}" STREQUAL "") AND NOT TARGET stmm-swapper)
#     if (BUILD_SHARED_LIBS)
#         add_library(stmm-swapper SHARED IMPORTED)
#     else()
#         add_library(stmm-swapper STATIC IMPORTED)
#     endif()
#     set_target_properties(stmm-swapper PROPERTIES IMPORTED_LOCATION             "${STMMI_LIB_FILE}")
#     set_target_properties(stmm-swapper PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${STMMSWAPPER_INCLUDE_DIRS}")
#     set_target_properties(stmm-swapper PROPERTIES INTERFACE_LINK_LIBRARIES      "${STMMSWAPPER_EXTRA_LIBRARIES}")
# endif()
