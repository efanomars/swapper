...
def main():
	...
	print("== install libstmm-swapper =============" + sInfo + "==")
	os.chdir("libstmm-swapper/scripts")
	subprocess.check_call("./install_libstmm-swapper.py {} {} {} {} {} {} {} {} {} {} {}".format(\
	...
	print("== install libstmm-swapper-xml ==========" + sInfo + "==")
	os.chdir("libstmm-swapper-xml/scripts")
	subprocess.check_call("./install_libstmm-swapper-xml.py {} {} {} {} {} {} {} {} {} {}".format(\
			sBuildStaticLib, sBuildTests, sBuildDocs, sDocsWarningsToLog, sBuildType, sInstallDir\
			, sNoConfigure, sNoMake, sNoInstall, sSudo).split())
	os.chdir("../..")

	print("== install swapper ==========" + sInfo + "==")
	os.chdir("swapper/scripts")
	subprocess.check_call("./install_swapper.py {} {} {} {} {} {} {} {} {}".format(sBuildStaticLib, sBuildType\
